<template>
  <el-card class="blog-articles-page">
    ...
    <el-form :inline="true" :model="articleFilter" class="demo-form-inline">
      <el-form-item>
        <el-select v-model="articleFilter.category" value-key="_id" placeholder="分类选择" size="mini" clearable>
          <el-option lable="全部" :value="''"></el-option>
          <el-option v-for="c in categoryList" :key="c._id" :label="c.name" :value="c.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-select v-model="articleFilter.tag" value-key="_id" placeholder="标签选择" size="mini" clearable>
          <el-option label="全部" :value="''">
          </el-option>
          <el-option v-for="c in tagList" :key="c._id" :label="c.name" :value="c._id">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <ArticlesList :list="articleList" :pagination="pagination" :loading="articleListFetching" @page-change="handlePageChange" @toggle-publish="handleTogglePublish" @edit="handleEdit" @delete="handleDelete" @sort="handleSort">
    </ArticlesList>
  </el-card>
</template>
