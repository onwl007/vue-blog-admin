<template>
  <el-card class="blog-tags-page">
    ...
    <el-table class="tags-table" v-loading="tagListFetching" element-loading-text="LOADING" :data="tagList">
    ...
    <el-dialog title="标签编辑" width="500px" center v-if="model" :visible.async="!!model" @close="handleCloseEditBox">
