<template>
  <section class="setting-page">
    <FormEdit :loading="optionEditing" :showCancel="false" @submit="handleSubmit" v-if="model">
      <el-row :gutter="24">
        <el-col :span="12">
          <el-card>
            <div slot="header">
    ...
    <el-dialog title="图片预览" width="60%" center top="5vh" :visible.async="!!previewUrl" @close="handleClosePreview">
...
.setting-page {
  ...
  .banner-item, .desc-item, .hobby-item, .experience-item, .skill-item, .links-item {
    position: relative;
    margin-bottom: 16px;
